...
const BaseError = QError.BaseError;
const Errors = QError.Errors;
...
export default class SequelizeDao {
    ...
    constructor(public modelName: string, public instanceName: string) {
        this._logger = new Logger('Sequelizer.' + (instanceName ? instanceName : '<default>') + '.' + modelName);
    }
    ...
    _withTx(ctx: any, options: any): Promise<any> {
        const tx = ctx.tx;
        if (tx && !tx.ignore) {
    ...
    get(ctx: any, id: string | number, options: Sequelize.FindOptions<any>): Promise<any> {
    ...
    load(ctx: any, id: string | number, options: Sequelize.FindOptions<any>) {
    ...
    raiseEntityNotFoundError(id: string | number) {
        throw new BaseError(Errors.ENTITY_NOT_FOUND, this.modelName, id);
    }

    /** 用id数组获取对应的数据对象，返回Promise<entity[]> */
    list(ctx: any, idArray: Array<string | number>, options: Sequelize.FindOptions<any>): Promise<any> {
    ...
    orderedList(ctx: any, idArray: Array<string | number>, options: Sequelize.FindOptions<any>): Promise<any[]> {
        if (!idArray || !idArray.length) return Promise.resolve([]);
    ...
    map(ctx: any, idArray: Array<string | number>, options: Sequelize.FindOptions<any>) {
        if (!idArray || !idArray.length) return Promise.resolve({});
    ...
    fieldMap(ctx: any, idArray: Array<string | number>, fieldName: string, options: Sequelize.FindOptions<any>) {
        if (!idArray || !idArray.length) return Promise.resolve({});
    ...
    findAll(ctx: any, options?: Sequelize.FindOptions<any>) {
        return this._withTx(ctx, options)
            .then((options: Sequelize.FindOptions<any>) => this.model.findAll(options));
    }

    /** 同findAll */
    find(ctx: any, options?: Sequelize.FindOptions<any>) {
        return this.findAll(ctx, options);
    }

    /** 任意查询，返回1行结果，返回Promise<entity> */
    findOne(ctx: any, options?: Sequelize.FindOptions<any>) {
        return this._withTx(ctx, options)
    ...
    page(ctx: any, options?: Sequelize.FindOptions<any>, offset = 0, limit = 0) {
        if (!options) options = {};
    ...
    pageAndCount(ctx: any, options?: Sequelize.FindOptions<any>, offset = 0, limit = 0) {
        if (!options) options = {};
        _.merge(options, { limit, offset });
    ...
    exists(ctx: any, id: string | number, options?: Sequelize.FindOptions<any>) {
        options = this._where(options);
        const idField = this.idFields()[0];
    ...
    count(ctx: any, options?: Sequelize.FindOptions<any>) {
        return this._withTx(ctx, options)
            .then(options => this.model.count(options));
    }

    /** 创建一个entity，返回Promise<entity> */
    insert(ctx: any, values: any, options?: Sequelize.CreateOptions) {
        return this._withTx(ctx, options)
            .then(options => this.model.create(values, options));
    }

    /** 更新一个entity，返回Promise<entity> */
    update(ctx: any, entity: any, values: any, options?: Sequelize.UpdateOptions) {
    ...
    updateById(ctx: any, id: string | number, values: any, options?: Sequelize.UpdateOptions) {
        return this.load(ctx, id, <any>options)
            .then((entity: any) => this.update(ctx, entity, values, options));
    }

    /** 创建或更新一个entity */
    upsert(ctx: any, values: any, options?: Sequelize.UpsertOptions) {
        return this._withTx(ctx, options)
            .then(options => this.model.upsert(values, options));
    }

    /** 递增一组field，返回Promise<entity> */
    inc(ctx: any, entity: any, fields: any[], options?: Sequelize.UpdateOptions) {
        return this._withTx(ctx, options)
            .then(options => entity.increment(fields, options));
    }

    /** 用id取得一个entity，然后递增这个entity的一组field，返回Promise<entity> */
    incById(ctx: any, id: string | number, fields: any[], options?: Sequelize.UpdateOptions) {
        return this.load(ctx, id, <any>options)
            .then((entity: any) => this.inc(ctx, entity, fields, options));
    }

    /** 递减一组field，返回Promise<entity> */
    dec(ctx: any, entity: any, fields: any[], options?: Sequelize.UpdateOptions) {
        return this._withTx(ctx, options)
            .then(options => entity.decrement(fields, options));
    }

    /** 用id取得一个entity，然后递减这个entity的一组field，返回Promise<entity> */
    decById(ctx: any, id: string | number, fields: any[], options?: Sequelize.UpdateOptions) {
        return this.load(ctx, id, <any>options)
            .then((entity: any) => this.dec(ctx, entity, fields, options));
    }

    remove(ctx: any, entity: any, options?: Sequelize.DestroyOptions) {
        return this._withTx(ctx, options)
            .then(options => entity.destroy(options));
    }

    removeById(ctx: any, id: string | number, options?: Sequelize.DestroyOptions) {
        return this.load(ctx, id, <any>options)
            .then((entity: any) => this.remove(ctx, entity, options));
    }

    distinctFields(ctx: any, fieldName: string, options?: Sequelize.FindOptions<any>) {
        options = this._where(options);
